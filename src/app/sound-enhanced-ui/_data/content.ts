...
export const features: Feature[] = [
  { num: "01", title: 'Sampled extraction', text: 'Every question type, well recorded.' },
  { num: "02", title: 'Alert marking', text: 'Negatives as gentle chimes.' },
  { num: "03", title: 'Narrated instructions', text: 'Verbatim, calm voice.' },
  { num: "04", title: 'Upbeat speed', text: 'Forty seconds at 120 BPM.' },
  { num: "05", title: 'Rhythmic palette', text: 'Answered, marked, unvisited beats.' },
  { num: "06", title: 'Encore analysis', text: 'Scores with applause track.' },
];
