...
export const features: Feature[] = [
  { num: "01", title: 'Pressure extraction', text: 'Every question type, compressed perfectly.' },
  { num: "02", title: 'Benthic marking', text: 'Negatives glow in the dark.' },
  { num: "03", title: 'Strata instructions', text: 'Verbatim, layer by layer.' },
  { num: "04", title: 'Fast descent', text: 'Forty seconds to the bottom.' },
  { num: "05", title: 'Sonar palette', text: 'Answered, marked, unvisited pings.' },
  { num: "06", title: 'Core samples', text: 'Scores drilled accurately.' },
];
