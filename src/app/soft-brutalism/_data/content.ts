...
export const features: Feature[] = [
  { num: "01", title: 'Puffy extraction', text: 'Every question type, softly boxed.' },
  { num: "02", title: 'Gentle marking', text: 'Negatives in pastel chips.' },
  { num: "03", title: 'Cozy instructions', text: 'Original pages, warmly kept.' },
  { num: "04", title: 'Quick puff', text: 'Forty seconds, no stress.' },
  { num: "05", title: 'Round palette', text: 'Answered, marked, unvisited — pebble smooth.' },
  { num: "06", title: 'Kind analysis', text: 'Scores delivered with a smile.' },
];
