...
export const features: Feature[] = [
  { num: "01", title: 'Prism extraction', text: 'Every question type, wavelength-separated.' },
  { num: "02", title: 'Iridescent marking', text: 'Negatives shimmering at every angle.' },
  { num: "03", title: 'Ghost instructions', text: 'Verbatim, floating in light.' },
  { num: "04", title: 'Lightspeed', text: 'Forty seconds at c.' },
  { num: "05", title: 'Spectra palette', text: 'Answered, marked, unvisited rainbows.' },
  { num: "06", title: 'Bright analysis', text: 'Scores in full color.' },
];
