...
export const features: Feature[] = [
  { num: "01", title: 'VHS extraction', text: 'Every question type, tracking-adjusted.' },
  { num: "02", title: 'Neon marking', text: 'Negatives in chrome pink.' },
  { num: "03", title: 'Mall instructions', text: 'Verbatim, echoing through the food court.' },
  { num: "04", title: 'Slowed speed', text: 'Forty seconds stretched beautifully.' },
  { num: "05", title: 'Grid palette', text: 'Answered, marked, unvisited — sunset coded.' },
  { num: "06", title: 'After-hours analysis', text: 'Scores under palm trees.' },
];
