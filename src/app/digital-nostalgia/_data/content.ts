...
export const features: Feature[] = [
  { num: "01", title: 'Blinking extraction', text: 'Every question type with <blink> energy.' },
  { num: "02", title: 'Marquee marking', text: 'Negatives scroll by for your convenience.' },
  { num: "03", title: 'MIDI instructions', text: 'Verbatim, with optional background music.' },
  { num: "04", title: '56k speed', text: 'Forty seconds, faster than downloading one MP3.' },
  { num: "05", title: 'Tiled palette', text: 'Starfield background, readable text.' },
  { num: "06", title: 'Guestbook analysis', text: 'Sign your score and leave a comment!!' },
];
