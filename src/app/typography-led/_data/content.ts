...
export const features: Feature[] = [
  { num: "01", title: 'Display extraction', text: 'Every question type at display size.' },
  { num: "02", title: 'Bold marking', text: 'Negatives in black weight.' },
  { num: "03", title: 'Text instructions', text: 'Verbatim, beautifully leaded.' },
  { num: "04", title: 'Fast setting', text: 'Forty seconds to locked type.' },
  { num: "05", title: 'Sorts palette', text: 'Answered, marked, unvisited sorts.' },
  { num: "06", title: 'Colophon analysis', text: 'Scores with full type credits.' },
];
