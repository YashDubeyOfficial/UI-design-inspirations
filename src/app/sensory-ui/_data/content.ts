...
export const features: Feature[] = [
  { num: "01", title: 'Vivid extraction', text: 'Every question type in high saturation.' },
  { num: "02", title: 'Audible marking', text: 'Negatives you can practically hear.' },
  { num: "03", title: 'Tactile instructions', text: 'Verbatim with texture.' },
  { num: "04", title: 'Warm speed', text: 'Forty seconds, toasty.' },
  { num: "05", title: 'Chunky palette', text: 'Answered, marked, unvisited you can grab.' },
  { num: "06", title: 'Glowing analysis', text: 'Scores with afterglow.' },
];
