...
export default function HeroVisual() {
  return (
    <div className={styles["hero-visual"]}>
      <div className={styles["visual-top"]}><span>Parakh CBT — Neo · Mock 01</span><span>02:47:12</span></div>
      <div className={styles["visual-grid"]}>
        <div className={styles["visual-left"]}>
          <div className={styles["meta-label"]}><i></i>Q14 · Physics · +4 −1</div>
        ...
        <div className={styles["visual-right"]}>
          <div className={styles["meta-label"]}><i></i>Palette · 14 / 90</div>
