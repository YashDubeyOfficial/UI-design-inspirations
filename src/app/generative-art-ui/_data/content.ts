...
export const features: Feature[] = [
  { num: "01", title: 'Seeded extraction', text: 'Every question type, grown fresh.' },
  { num: "02", title: 'Blooming marking', text: 'Negatives flower on time.' },
  { num: "03", title: 'Wild instructions', text: 'Verbatim, beautifully overgrown.' },
  { num: "04", title: 'Fast germination', text: 'Forty seconds from seed to hall.' },
  { num: "05", title: 'Pollen palette', text: 'Answered, marked, unvisited drift.' },
  { num: "06", title: 'Harvest analysis', text: 'Scores picked ripe.' },
];
