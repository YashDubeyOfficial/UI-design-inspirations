...
export const features: Feature[] = [
  { num: "01", title: 'PACKET EXTRACTION', text: 'Question types from broken files.' },
  { num: "02", title: 'STATIC MARKING', text: 'Negatives through the noise.' },
  { num: "03", title: 'GHOST INSTRUCTIONS', text: 'Verbatim, flickering.' },
  { num: "04", title: 'OVERCLOCKED', text: 'Forty seconds at 2x speed.' },
  { num: "05", title: 'NOISY PALETTE', text: 'Answered, marked, lost — all visible.' },
  { num: "06", title: 'POST-MORTEM', text: 'Scores from the wreckage.' },
];
