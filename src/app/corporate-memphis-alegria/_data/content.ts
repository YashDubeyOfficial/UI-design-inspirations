...
export const features: Feature[] = [
  { num: "01", title: 'Welcoming extraction', text: 'Every question type, greeted.' },
  { num: "02", title: 'Pointed marking', text: 'Negatives indicated kindly.' },
  { num: "03", title: 'Smiling instructions', text: 'Verbatim with a grin.' },
  { num: "04", title: 'Brisk onboarding', text: 'Forty seconds to belonging.' },
  { num: "05", title: 'Diverse palette', text: 'Answered, marked, unvisited together.' },
  { num: "06", title: 'Celebrated analysis', text: 'Scores with confetti arms.' },
];
