...
export const features: Feature[] = [
  { num: "01", title: 'Plot extraction', text: 'Every question type, a character.' },
  { num: "02", title: 'Conflict marking', text: 'Negatives as worthy villains.' },
  { num: "03", title: 'Prologue instructions', text: 'Verbatim opening lines.' },
  { num: "04", title: 'Pacy middle', text: 'Forty seconds, page-turner.' },
  { num: "05", title: 'Climax palette', text: 'Answered, marked, unvisited twists.' },
  { num: "06", title: 'Denouement analysis', text: 'Scores resolve everything.' },
];
