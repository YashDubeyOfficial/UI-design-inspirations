...
export const features: Feature[] = [
  { num: "01", title: 'Trail extraction', text: 'Every question type, blazed.' },
  { num: "02", title: 'Stamped marking', text: 'Negatives branded clearly.' },
  { num: "03", title: 'Logged instructions', text: 'Verbatim in the field book.' },
  { num: "04", title: 'Swift ascent', text: 'Forty seconds to high camp.' },
  { num: "05", title: 'Cairn palette', text: 'Answered, marked, unvisited stones.' },
  { num: "06", title: 'Summit analysis', text: 'Scores with a view.' },
];
