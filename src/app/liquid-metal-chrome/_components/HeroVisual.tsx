...
export default function HeroVisual() {
  return (
    <div className={styles["hero-visual"]}>
      <div className={styles["visual-top"]}><span>Parakh Chrome — Mock 01</span><span className={styles.live}>● 02:47:12</span></div>
      <div className={styles["visual-grid"]}>
        ...
        <div className={styles["visual-right"]}>
          ...
          <div className={styles["timer-sub"]}>molten · auto-freeze at zero</div>
