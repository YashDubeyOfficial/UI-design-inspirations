...
export const features: Feature[] = [
  { num: "01", title: 'Dealt extraction', text: 'Every question type, new hand daily.' },
  { num: "02", title: 'Wild marking', text: 'Negatives as jokers, clearly marked.' },
  { num: "03", title: 'Table instructions', text: 'Verbatim, read them and weep (with joy).' },
  { num: "04", title: 'Quick shuffle', text: 'Forty seconds to deal.' },
  { num: "05", title: 'Suited palette', text: 'Answered, marked, unvisited suits.' },
  { num: "06", title: 'Counted analysis', text: 'Scores. Card counting allowed.' },
];
