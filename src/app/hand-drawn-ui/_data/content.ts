...
export const features: Feature[] = [
  { num: "01", title: 'Doodled extraction', text: 'Every question type, sketched fast.' },
  { num: "02", title: 'Circled marking', text: 'Negatives ringed in red pen.' },
  { num: "03", title: 'Margin instructions', text: 'Verbatim, with arrows and stars.' },
  { num: "04", title: 'Quick sketch', text: 'Forty seconds, one continuous line.' },
  { num: "05", title: 'Doodle palette', text: 'Answered = filled in. Obviously.' },
  { num: "06", title: 'Report card', text: 'Scores in big red pen. Kind of.' },
];
