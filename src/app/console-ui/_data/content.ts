...
export const features: Feature[] = [
  { num: "01", title: 'Cartridge extraction', text: 'Every question type, blow-tested.' },
  { num: "02", title: 'Combo marking', text: 'Negatives cost exactly one life.' },
  { num: "03", title: 'Manual pages', text: 'Instructions like a booklet. Verbatim.' },
  { num: "04", title: 'Speedrun mode', text: 'Forty seconds, world record pace.' },
  { num: "05", title: 'Achievement palette', text: 'Answered, marked, unvisited trophies.' },
  { num: "06", title: 'High-score analysis', text: 'Initials optional, glory assured.' },
];
