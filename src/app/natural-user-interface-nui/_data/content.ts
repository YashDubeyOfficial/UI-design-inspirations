...
export const features: Feature[] = [
  { num: "01", title: 'Pointed extraction', text: 'Every question type, indicated.' },
  { num: "02", title: 'Glanced marking', text: 'Negatives seen and noted.' },
  { num: "03", title: 'Heard instructions', text: 'Verbatim, listened well.' },
  { num: "04", title: 'Instant grasp', text: 'Forty seconds, first try.' },
  { num: "05", title: 'Eyed palette', text: 'Look to mark. Blink to lock. (Almost.)' },
  { num: "06", title: 'Told analysis', text: 'Scores spoken plainly.' },
];
