...
export const features: Feature[] = [
  { num: "01", title: 'Tiered extraction', text: 'Every question type, plated.' },
  { num: "02", title: 'Filled marking', text: 'Negatives with clotted precision.' },
  { num: "03", title: 'Doily instructions', text: 'Verbatim on lace paper.' },
  { num: "04", title: 'Prompt service', text: 'Forty seconds, piping hot.' },
  { num: "05", title: 'Assorted palette', text: 'Answered, marked, unvisited selection.' },
  { num: "06", title: 'Bill analysis', text: 'Scores presented discreetly.' },
];
