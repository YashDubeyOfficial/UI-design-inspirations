...
export const features: Feature[] = [
  { num: "01", title: 'SP extraction', text: 'Every question type in extended play.' },
  { num: "02", title: 'Paused marking', text: 'Negatives freeze-framed exactly.' },
  { num: "03", title: 'OSD instructions', text: 'Verbatim, overlaid on blue.' },
  { num: "04", title: 'FF speed', text: 'Forty seconds at double speed.' },
  { num: "05", title: 'Rewind palette', text: 'Answered, marked, unvisited — rewatchable.' },
  { num: "06", title: 'Record analysis', text: 'Scores taped over nothing important.' },
];
