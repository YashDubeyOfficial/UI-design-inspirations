...
export const features: Feature[] = [
  { num: "01", title: 'Recycled extraction', text: 'Every question type, second-hand paper friendly.' },
  { num: "02", title: 'Efficient marking', text: 'Negatives with tiny footprint.' },
  { num: "03", title: 'Paperless instructions', text: 'Verbatim, zero trees.' },
  { num: "04", title: 'Quick cycle', text: 'Forty seconds on solar.' },
  { num: "05", title: 'Low-power palette', text: 'Three states, dimmed kindly.' },
  { num: "06", title: 'Honest analysis', text: 'Scores plus your saved CO₂.' },
];
