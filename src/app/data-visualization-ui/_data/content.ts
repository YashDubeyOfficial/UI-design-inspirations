...
export const features: Feature[] = [
  { num: "01", title: 'Scatter extraction', text: 'Every question type, one dot each.' },
  { num: "02", title: 'Error-bar marking', text: 'Negatives with confidence intervals.' },
  { num: "03", title: 'Caption instructions', text: 'Verbatim, Figure 0.' },
  { num: "04", title: 'Fast render', text: 'Forty seconds at 60fps.' },
  { num: "05", title: 'Legend palette', text: 'Answered, marked, unvisited series.' },
  { num: "06", title: 'Dashboard analysis', text: 'The main event, frankly.' },
];
