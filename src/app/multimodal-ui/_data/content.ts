...
export const features: Feature[] = [
  { num: "01", title: 'Text extraction', text: 'Every question type, typed or scanned.' },
  { num: "02", title: 'Voice marking', text: 'Dictate negatives, confirmed back.' },
  { num: "03", title: 'Image instructions', text: 'Photographed pages, read verbatim.' },
  { num: "04", title: 'Fast merge', text: 'Forty seconds across channels.' },
  { num: "05", title: 'Unified palette', text: 'All inputs, one state model.' },
  { num: "06", title: 'Mixed analysis', text: 'Scores however you ask.' },
];
