...
export const features: Feature[] = [
  { num: "01", title: 'Rocket extraction', text: 'Every question type, escape velocity.' },
  { num: "02", title: 'Atomic marking', text: 'Negatives half-life: exactly as printed.' },
  { num: "03", title: 'Flight manual', text: 'Instructions verbatim, mission-approved.' },
  { num: "04", title: 'Light speed', text: 'Forty seconds, faster than Sputnik.' },
  { num: "05", title: 'Stellar palette', text: 'Answered, marked, unvisited constellations.' },
  { num: "06", title: 'Telemetry', text: 'Scores beamed back clearly.' },
];
