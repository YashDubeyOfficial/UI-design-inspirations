...
export const features: Feature[] = [
  { num: "01", title: 'Modeled extraction', text: 'Every question type, weighted.' },
  { num: "02", title: 'Projected marking', text: 'Negatives with confidence.' },
  { num: "03", title: 'Cited instructions', text: 'Verbatim, sourced.' },
  { num: "04", title: 'Fast inference', text: 'Forty seconds per forecast.' },
  { num: "05", title: 'Likely palette', text: 'Answered 82%, marked 12%.' },
  { num: "06", title: 'Forecast analysis', text: 'Scores with error bars.' },
];
