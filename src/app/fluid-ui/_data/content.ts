...
export const features: Feature[] = [
  { num: "01", title: 'Liquid extraction', text: 'Every question type, poured.' },
  { num: "02", title: 'Current marking', text: 'Negatives downstream, clearly.' },
  { num: "03", title: 'Drift instructions', text: 'Verbatim, floating past.' },
  { num: "04", title: 'Fast current', text: 'Forty seconds to the sea.' },
  { num: "05", title: 'Ripple palette', text: 'Answered, marked, unvisited waves.' },
  { num: "06", title: 'Tide analysis', text: 'Scores wash up accurately.' },
];
