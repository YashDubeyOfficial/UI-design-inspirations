...
export const features: Feature[] = [
  { num: "01", title: 'Strata extraction', text: 'Every question type, depth-sorted.' },
  { num: "02", title: 'Shadow marking', text: 'Negatives cast long and clear.' },
  { num: "03", title: 'Bedrock instructions', text: 'Verbatim at the bottom.' },
  { num: "04", title: 'Fast fall', text: 'Forty seconds terminal velocity.' },
  { num: "05", title: 'Floating palette', text: 'Answered, marked, unvisited altitudes.' },
  { num: "06", title: 'Surface analysis', text: 'Scores float back up.' },
];
