...
export const features: Feature[] = [
  { num: "01", title: 'Goal extraction', text: 'Every question type serving the goal.' },
  { num: "02", title: 'Aligned marking', text: 'Negatives framed as progress.' },
  { num: "03", title: 'Briefed instructions', text: 'Verbatim, goal-relevant.' },
  { num: "04", title: 'Direct speed', text: 'Forty seconds to the point.' },
  { num: "05", title: 'Proof palette', text: 'Answered, marked, unvisited evidence.' },
  { num: "06", title: 'Outcome analysis', text: 'Scores versus the goal.' },
];
