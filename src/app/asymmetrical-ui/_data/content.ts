...
export const features: Feature[] = [
  { num: "01", title: 'Tilted extraction', text: 'Every question type, slightly rotated.' },
  { num: "02", title: 'Off-kilter marking', text: 'Negatives where you least expect, always found.' },
  { num: "03", title: 'Sideways instructions', text: 'Verbatim, just leaning.' },
  { num: "04", title: 'Rushed nicely', text: 'Forty seconds, fashionably late never.' },
  { num: "05", title: 'Wobbly palette', text: 'Answered, marked, unvisited — dancing.' },
  { num: "06", title: 'Askew analysis', text: 'Scores leaning in to tell you.' },
];
