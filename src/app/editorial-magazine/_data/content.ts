...
export const features: Feature[] = [
  { num: "01", title: 'Feature extraction', text: 'Every question type, above the fold.' },
  { num: "02", title: 'Style guide marking', text: 'Negatives per the manual.' },
  { num: "03", title: 'Contributors instructions', text: 'Verbatim, with bylines.' },
  { num: "04", title: 'Deadline speed', text: 'Forty seconds to press time.' },
  { num: "05", title: 'Color palette', text: 'Answered, marked, unvisited inks.' },
  { num: "06", title: 'Letters analysis', text: 'Scores from our readers.' },
];
