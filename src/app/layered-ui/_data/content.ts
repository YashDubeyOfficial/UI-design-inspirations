...
export const features: Feature[] = [
  { num: "01", title: 'Sheet extraction', text: 'Every question type, one layer each.' },
  { num: "02", title: 'Overlay marking', text: 'Negatives on tracing film.' },
  { num: "03", title: 'Vellum instructions', text: 'Verbatim, see-through.' },
  { num: "04", title: 'Quick stack', text: 'Forty seconds to full pile.' },
  { num: "05", title: 'Shuffle palette', text: 'Answered, marked, unvisited layers.' },
  { num: "06", title: 'Top-sheet analysis', text: 'Scores on the cover sheet.' },
];
