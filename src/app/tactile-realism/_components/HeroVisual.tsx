...
export default function HeroVisual() {
  return (
    <div className={styles["hero-visual"]}>
      <div className={styles["visual-top"]}><span>Parakh Tailored — Mock 01</span><span>02:47:12</span></div>
      <div className={styles["visual-grid"]}>
        ...
        <div className={styles["visual-right"]}>
          ...
          <div className={styles["timer-sub"]}>woven · knots at zero</div>
          ...
          <div className={styles.stitch}>Instructions stitched along the seam — read before pressing start.</div>
        </div>
      </div>
    </div>
  );
