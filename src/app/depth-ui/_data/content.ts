...
export const features: Feature[] = [
  { num: "01", title: 'Soft extraction', text: 'Every question type, lifted kindly.' },
  { num: "02", title: 'Muted marking', text: 'Negatives in soft teal.' },
  { num: "03", title: 'Pillow instructions', text: 'Verbatim on cushions.' },
  { num: "04", title: 'Easy speed', text: 'Forty soft seconds.' },
  { num: "05", title: 'Cloud palette', text: 'Answered, marked, unvisited puffs.' },
  { num: "06", title: 'Restful analysis', text: 'Scores on a chaise.' },
];
