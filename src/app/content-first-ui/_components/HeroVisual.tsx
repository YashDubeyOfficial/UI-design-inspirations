...
export default function HeroVisual() {
  return (
    <div className={styles["hero-visual"]}>
      <div className={styles["visual-top"]}><span>Parakh CBT — Editorial · Mock 01</span><span>02:47:12</span></div>
      <div className={styles["visual-grid"]}>
        ...
        <div className={styles["visual-right"]}>
          <div className={styles["meta-label"]}>Marginalia · 14 / 90</div>
          <div className={styles.timer}>02:47:12</div>
          <div className={styles["timer-sub"]}>remaining · set small, on purpose</div>
