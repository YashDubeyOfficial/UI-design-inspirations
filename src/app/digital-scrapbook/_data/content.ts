...
export const features: Feature[] = [
  { num: "01", title: 'Pressed extraction', text: 'Every question type, flattened beautifully.' },
  { num: "02", title: 'Washi marking', text: 'Negatives taped, never lost.' },
  { num: "03", title: 'Journal instructions', text: 'Verbatim in lovely handwriting-ish type.' },
  { num: "04", title: 'Crafty speed', text: 'Forty seconds of pure fun.' },
  { num: "05", title: 'Sticker palette', text: 'Answered, marked, unvisited — collect them all.' },
  { num: "06", title: 'Memory-book analysis', text: 'Scores worth scrapbooking.' },
];
