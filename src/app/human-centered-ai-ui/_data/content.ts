...
export const features: Feature[] = [
  { num: "01", title: 'Gentle extraction', text: 'Every question type, carefully lifted.' },
  { num: "02", title: 'Fair marking', text: 'Negatives explained, never sprung.' },
  { num: "03", title: 'Open instructions', text: 'Verbatim, always inspectable.' },
  { num: "04", title: 'Patient speed', text: 'Forty seconds, unhurried feeling.' },
  { num: "05", title: 'Kind palette', text: 'Answered, marked, unvisited softly.' },
  { num: "06", title: 'Encouraging analysis', text: 'Scores with next-step kindness.' },
];
