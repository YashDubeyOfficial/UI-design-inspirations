...
export default function HeroVisual() {
  return (
    <div className={styles["hero-visual"]}>
      <div className={styles["visual-top"]}><span><i></i>Parakh Desk — Mock 01 · 02:47:12</span><span>+4 −1</span></div>
      <div className={styles["visual-grid"]}>
        <div className={styles["visual-left"]}>
          <div className={styles["meta-label"]}>Q14 · Physics · Stamped</div>
        ...
        <div className={styles["visual-right"]}>
          ...
          <div className={styles.stitch}>Instructions stitched in — read before you press start. Auto-submit locks at zero.</div>
          <div className={styles.knobs}><span className={styles.knob}></span><span className={styles.knob}></span><span className={styles.knob}></span></div>
