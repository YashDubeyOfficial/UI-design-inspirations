...
export const features: Feature[] = [
  { num: "01", title: 'Speedline extraction', text: 'Every question type, motion-blurred in.' },
  { num: "02", title: 'Afterburn marking', text: 'Negatives with flame trails.' },
  { num: "03", title: 'Wind instructions', text: 'Verbatim at speed.' },
  { num: "04", title: 'Top speed', text: 'Forty seconds, redlined.' },
  { num: "05", title: 'Blur palette', text: 'Answered, marked, unvisited streaks.' },
  { num: "06", title: 'Photo-finish analysis', text: 'Scores by milliseconds.' },
];
