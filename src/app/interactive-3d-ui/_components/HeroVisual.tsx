  ...
  return (
    <div className={styles["hero-visual"]}>
      <div className={styles.deck}>
        <div className={`${styles["deck-card"]} ${styles.back}`} aria-hidden="true"></div>
        <div className={styles["deck-card"]}>
          <div className={styles["visual-top"]}><span>Parakh Deck — Mock 01</span><span className={styles.live}>● 02:47:12</span></div>
          <div className={styles["visual-grid"]}>
            ...
            <div className={styles["visual-right"]}>
              ...
              <div className={styles["timer-sub"]}>hover to inspect · locks at zero</div>
