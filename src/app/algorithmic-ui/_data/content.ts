...
export const features: Feature[] = [
  { num: "01", title: 'parse() questions', text: 'Every type handled, edge cases included.' },
  { num: "02", title: 'detect() marking', text: 'Negatives with 100% precision.' },
  { num: "03", title: 'keep() instructions', text: 'Verbatim, immutable.' },
  { num: "04", title: 'run() fast', text: 'Forty seconds wall-clock.' },
  { num: "05", title: 'state() palette', text: 'Answered, marked, unvisited enums.' },
  { num: "06", title: 'report() scores', text: 'Charts, not vibes.' },
];
