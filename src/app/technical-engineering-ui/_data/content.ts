...
export const features: Feature[] = [
  { num: "01", title: 'Measured extraction', text: 'Every question type, three decimals.' },
  { num: "02", title: 'Reference marking', text: 'Negatives traceable to source.' },
  { num: "03", title: 'Logged instructions', text: 'Verbatim with timestamps.' },
  { num: "04", title: 'Forty seconds', text: 'Mean time, σ small.' },
  { num: "05", title: 'Calibrated palette', text: 'Answered, marked, unvisited references.' },
  { num: "06", title: 'Certified analysis', text: 'Scores with confidence intervals.' },
];
