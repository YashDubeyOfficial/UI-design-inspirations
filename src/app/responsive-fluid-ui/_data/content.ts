...
export const features: Feature[] = [
  { num: "01", title: 'Reflow extraction', text: 'Every question type, any width.' },
  { num: "02", title: 'Elastic marking', text: 'Negatives stretch, never break.' },
  { num: "03", title: 'Liquid instructions', text: 'Verbatim at every size.' },
  { num: "04", title: 'Fast flow', text: 'Forty seconds, all viewports.' },
  { num: "05", title: 'Adaptive palette', text: 'Answered, marked, unvisited everywhere.' },
  { num: "06", title: 'Responsive analysis', text: 'Scores fit any screen.' },
];
