    ...
    <details className={styles.fab}>
      ...
      <div className={`${styles['fab-panel']}`}>
        ...
        <div className={`${styles['fab-grid']}`}>
          ...
          <Link href="/" className={`${styles['fab-link']} ${styles.active}`}>Neumorphic <small>Soft extruded</small></Link>
          <Link href="/skeuomorphic" className={`${styles['fab-link']}`}>Skeuomorphic <small>Wood + paper</small></Link>
