...
export const features: Feature[] = [
  { num: "01", title: 'TARGET EXTRACTION', text: 'Question types acquired and tracked.' },
  { num: "02", title: 'THREAT MARKING', text: 'Negatives flagged hostile.' },
  { num: "03", title: 'BRIEFING PAGES', text: 'Instructions verbatim on screen.' },
  { num: "04", title: 'AFTERBURN', text: 'Forty seconds to combat speed.' },
  { num: "05", title: 'RADAR PALETTE', text: 'Friendlies, bogeys, unknowns.' },
  { num: "06", title: 'DEBRIEF', text: 'Scores after the sortie.' },
];
