...
export const features: Feature[] = [
  { num: "01", title: 'Sensing extraction', text: 'Every question type, context-noted.' },
  { num: "02", title: 'Fitting marking', text: 'Negatives sized to your pace.' },
  { num: "03", title: 'Placed instructions', text: 'Verbatim where you look.' },
  { num: "04", title: 'Quick adapt', text: 'Forty seconds to reshape.' },
  { num: "05", title: 'Shifting palette', text: 'States that follow attention.' },
  { num: "06", title: 'Suited analysis', text: 'Scores framed your way.' },
];
