...
export const features: Feature[] = [
  { num: "01", title: 'EXTRACTION!!!', text: 'EVERY question type!!! Even ones not invented yet!!!' },
  { num: "02", title: 'MARKING!!!', text: 'Negatives!!! Positives!!! EVERYTHING!!!' },
  { num: "03", title: 'INSTRUCTIONS!!!', text: 'Verbatim!!! Exclamation!!! Included!!!' },
  { num: "04", title: 'SPEED!!!', text: 'FORTY SECONDS!!! WOW!!!' },
  { num: "05", title: 'PALETTE!!!', text: 'Answered!!! Marked!!! Unvisited!!! ALL THREE!!!' },
  { num: "06", title: 'ANALYSIS!!!', text: 'Scores!!! Charts!!! Stickers!!! Confetti!!!' },
];
