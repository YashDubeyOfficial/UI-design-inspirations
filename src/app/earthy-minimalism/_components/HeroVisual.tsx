...
export default function HeroVisual() {
  return (
    <div className={styles["hero-visual"]}>
      <div className={styles["visual-top"]}><span>Parakh CBT — Earthen · Mock 01</span><span>02:47:12</span></div>
      <div className={styles["visual-grid"]}>
        ...
        <div className={styles["visual-right"]}>
          ...
          <div className={styles["timer-sub"]}>remaining · auto-harvest at zero</div>
