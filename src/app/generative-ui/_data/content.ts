...
export const features: Feature[] = [
  { num: "01", title: 'Grown extraction', text: 'Every question type, cultivated.' },
  { num: "02", title: 'Ripening marking', text: 'Negatives sweeten on the vine.' },
  { num: "03", title: 'Pressed instructions', text: 'Verbatim, dried flat.' },
