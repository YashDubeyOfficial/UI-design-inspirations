...
export const features: Feature[] = [
  { num: "01", title: 'Loud extraction', text: 'Every question type, yelled into place.' },
  { num: "02", title: 'Louder marking', text: 'Negatives in shouty chips.' },
  { num: "03", title: 'Verbatim sheets', text: 'Instructions, unedited, unapologetic.' },
  { num: "04", title: 'Fast punch', text: 'Forty seconds, no wind-up.' },
  { num: "05", title: 'Chunky palette', text: 'Answered, marked, unvisited — fist-sized.' },
  { num: "06", title: 'Blunt analysis', text: 'Scores with no sugar coat.' },
];
