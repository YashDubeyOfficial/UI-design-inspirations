...
export const features: Feature[] = [
  { num: "01", title: 'KPI extraction', text: 'Every question type, metered.' },
  { num: "02", title: 'Alert marking', text: 'Negatives trigger gentle alarms.' },
  { num: "03", title: 'Docs instructions', text: 'Verbatim in the help drawer.' },
  { num: "04", title: 'Realtime parse', text: 'Forty seconds, live progress bar.' },
  { num: "05", title: 'Status palette', text: 'Answered, marked, unvisited LEDs.' },
  { num: "06", title: 'Report analysis', text: 'Scheduled, exportable, shareable.' },
];
