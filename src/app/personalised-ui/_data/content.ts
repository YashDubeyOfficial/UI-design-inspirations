...
export const features: Feature[] = [
  { num: "01", title: 'Noticed extraction', text: 'Every question type, your order.' },
  { num: "02", title: 'Familiar marking', text: 'Negatives how you like them shown.' },
  { num: "03", title: 'Kept instructions', text: 'Verbatim, bookmarked.' },
  { num: "04", title: 'Prompt service', text: 'Forty seconds, on your schedule.' },
  { num: "05", title: 'Known palette', text: 'States in your colors.' },
  { num: "06", title: 'Personal analysis', text: 'Scores with your name on them.' },
];
