...
export const features: Feature[] = [
  { num: "01", title: 'Shouted extraction', text: 'EVERY question type, heard clearly.' },
  { num: "02", title: 'Emphatic marking', text: 'Negatives with feeling.' },
  { num: "03", title: 'Aside instructions', text: '(Verbatim, in parentheses.)' },
  { num: "04", title: 'Staccato speed', text: 'Forty. Seconds. Done.' },
  { num: "05", title: 'Choir palette', text: 'Answered, marked, unvisited voices.' },
  { num: "06", title: 'Encore analysis', text: 'Scores demand applause.' },
];
