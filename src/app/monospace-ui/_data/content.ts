...
export const features: Feature[] = [
  { num: "01", title: 'Tabular extraction', text: 'Every question type, column-aligned.' },
  { num: "02", title: 'Fixed marking', text: 'Negatives at exact tab stops.' },
  { num: "03", title: 'Literal instructions', text: 'Verbatim, `<pre>`-served.' },
  { num: "04", title: 'Constant width', text: 'Forty seconds, every time.' },
  { num: "05", title: 'ASCII palette', text: '[x] answered, [!] marked, [ ] new.' },
  { num: "06", title: 'Plain analysis', text: 'Scores, space-padded.' },
];
