...
export const features: Feature[] = [
  { num: "01", title: 'Slider extraction', text: 'Every question type, quantized.' },
  { num: "02", title: 'Dial marking', text: 'Negatives from 0 to brutal.' },
  { num: "03", title: 'Toggle instructions', text: 'Verbatim, switchable.' },
  { num: "04", title: 'Fast compute', text: 'Forty seconds per render.' },
  { num: "05", title: 'Stepped palette', text: 'Answered, marked, unvisited detents.' },
  { num: "06", title: 'Exported analysis', text: 'Scores as clean JSON-ish cards.' },
];
