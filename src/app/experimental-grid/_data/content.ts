...
export const features: Feature[] = [
  { num: "01", title: 'Spanning extraction', text: 'Every question type across columns.' },
  { num: "02", title: 'Offset marking', text: 'Negatives pushed right, always visible.' },
  { num: "03", title: 'Overlapping instructions', text: 'Verbatim, layered precisely.' },
  { num: "04", title: 'Full-bleed speed', text: 'Forty seconds edge to edge.' },
  { num: "05", title: 'Nested palette', text: 'Answered, marked, unvisited — gridded.' },
  { num: "06", title: 'Footer analysis', text: 'Scores in the last row.' },
];
