...
export const features: Feature[] = [
  { num: "01", title: 'Considered extraction', text: 'Every question type, acknowledged.' },
  { num: "02", title: 'Confirming marking', text: 'Negatives nod before applying.' },
  { num: "03", title: 'Gentle instructions', text: 'Verbatim with a soft hello.' },
  { num: "04", title: 'Snappy speed', text: 'Forty seconds of small joys.' },
  { num: "05", title: 'Popping palette', text: 'Answered, marked, unvisited pings.' },
  { num: "06", title: 'Celebrating analysis', text: 'Scores with tasteful confetti.' },
];
