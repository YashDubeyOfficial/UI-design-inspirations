...
export const features: Feature[] = [
  { num: "01", title: 'TEXTMODE EXTRACTION', text: 'Every question type in 80 columns.' },
  { num: "02", title: 'BEEP MARKING', text: 'Negatives announced audibly.' },
  { num: "03", title: 'README.TXT', text: 'Instructions verbatim, paged.' },
  { num: "04", title: 'TURBO MODE', text: 'Forty seconds. *BEEP*.' },
  { num: "05", title: 'ANSI PALETTE', text: 'Answered, marked, unvisited — 16 colors.' },
  { num: "06", title: 'PRINT SCORES', text: 'Dot-matrix analysis on demand.' },
];
