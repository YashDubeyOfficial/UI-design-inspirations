...
export const features: Feature[] = [
  { num: "01", title: 'Weighty extraction', text: 'Every question type, tuned.' },
  { num: "02", title: 'Bold marking', text: 'Negatives at maximum weight.' },
  { num: "03", title: 'Light instructions', text: 'Verbatim at minimum weight.' },
  { num: "04", title: 'Instant interpolation', text: 'Forty seconds, all axes.' },
  { num: "05", title: 'Responsive palette', text: 'States that flex with context.' },
  { num: "06", title: 'Full-range analysis', text: 'Scores from hairline to black.' },
];
