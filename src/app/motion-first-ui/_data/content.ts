...
export const features: Feature[] = [
  { num: "01", title: 'Gliding extraction', text: 'Every question type, smooth entrance.' },
  { num: "02", title: 'Eased marking', text: 'Negatives with perfect timing.' },
  { num: "03", title: 'Floating instructions', text: 'Verbatim, drifting by.' },
  { num: "04", title: 'Tempo prestissimo', text: 'Forty seconds, allegro.' },
  { num: "05", title: 'Dancing palette', text: 'Answered, marked, unvisited steps.' },
  { num: "06", title: 'Curtain analysis', text: 'Scores with applause.' },
];
