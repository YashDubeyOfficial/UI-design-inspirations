...
export const features: Feature[] = [
  { num: "01", title: 'Heard extraction', text: 'Every question type, dictated or dropped.' },
  { num: "02", title: 'Spoken marking', text: 'Negatives read aloud on request.' },
  { num: "03", title: 'Recited instructions', text: 'Verbatim, pleasantly voiced.' },
  { num: "04", title: 'Quick ears', text: 'Forty seconds of listening.' },
  { num: "05", title: 'Called palette', text: '“Mark 14.” Done.' },
  { num: "06", title: 'Told analysis', text: 'Scores narrated kindly.' },
];
