...
export const features: Feature[] = [
  { num: "01", title: 'Curated extraction', text: 'Every question type, hung straight.' },
  { num: "02", title: 'Gilded marking', text: 'Negatives letterpressed in gold.' },
  { num: "03", title: 'Archived instructions', text: 'Original pages, catalogued verbatim.' },
  { num: "04", title: 'Forty seconds', text: ' swifter than the champagne service.' },
  { num: "05", title: 'Palette, framed', text: 'Answered, marked, unvisited — behind glass.' },
  { num: "06", title: 'Catalogued analysis', text: 'Scores with provenance.' },
];
