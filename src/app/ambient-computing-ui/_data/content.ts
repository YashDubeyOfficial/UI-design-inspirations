...
export const features: Feature[] = [
  { num: "01", title: 'Ambient extraction', text: 'Every question type, already ready.' },
  { num: "02", title: 'Gentle marking', text: 'Negatives noted politely.' },
  { num: "03", title: 'Nearby instructions', text: 'Verbatim, within glance.' },
  { num: "04", title: 'Timely speed', text: 'Forty seconds, unnoticed.' },
  { num: "05", title: 'Glance palette', text: 'Answered, marked, unvisited at a look.' },
  { num: "06", title: 'Surfaced analysis', text: 'Scores appear when relevant.' },
];
