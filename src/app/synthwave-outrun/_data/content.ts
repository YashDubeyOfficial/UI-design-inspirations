...
export const features: Feature[] = [
  { num: "01", title: 'Turbo extraction', text: 'Every question type at top speed.' },
  { num: "02", title: 'Nitro marking', text: 'Negatives with flame decals.' },
  { num: "03", title: 'Dashboard instructions', text: 'Verbatim on the heads-up display.' },
  { num: "04", title: 'Quarter mile', text: 'Forty seconds, standing start.' },
  { num: "05", title: 'Trail palette', text: 'Answered, marked, unvisited — light trails.' },
  { num: "06", title: 'Finish line analysis', text: 'Scores with checkered flags.' },
];
