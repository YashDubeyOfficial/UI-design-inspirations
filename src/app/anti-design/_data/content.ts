...
export const features: Feature[] = [
  { num: "01", title: 'CHAOTIC EXTRACTION', text: 'Every question type, fished from the mess.' },
  { num: "02", title: 'NEON MARKING', text: 'Negatives screaming in magenta.' },
  { num: "03", title: 'RAW INSTRUCTIONS', text: 'Unedited. Unstyled. Exact.' },
  { num: "04", title: 'FAST ANYWAY', text: 'Forty seconds despite appearances.' },
  { num: "05", title: 'LOUD PALETTE', text: 'Answered, marked, unvisited — all caps.' },
  { num: "06", title: 'BRUTAL ANALYSIS', text: 'Scores with no padding, literally.' },
];
