...
export const features: Feature[] = [
  { num: "01", title: 'Hand-stitched extraction', text: 'Every question type, sewn in.' },
  { num: "02", title: 'Embroidered marking', text: 'Negatives in french knots.' },
  { num: "03", title: 'Sampler instructions', text: 'Verbatim, cross-stitched.' },
  { num: "04", title: 'Quick seams', text: 'Forty seconds per garment.' },
  { num: "05", title: 'Button palette', text: 'Answered, marked, unvisited — wooden.' },
  { num: "06", title: 'Hemmed analysis', text: 'Scores with finished edges.' },
];
