...
export const features: Feature[] = [
  { num: "01", title: 'Traced extraction', text: 'Every question type, center-lined.' },
  { num: "02", title: 'Toleranced marking', text: 'Negatives ±0.00 exact.' },
  { num: "03", title: 'Noted instructions', text: 'Verbatim with leader arrows.' },
  { num: "04", title: 'Rapid drafting', text: 'Forty seconds from sketch to sheet.' },
  { num: "05", title: 'Hatched palette', text: 'Answered, marked, unvisited fills.' },
  { num: "06", title: 'Stamped analysis', text: 'Scores approved for construction.' },
];
