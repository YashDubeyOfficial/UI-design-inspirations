...
export const features: Feature[] = [
  { num: "01", title: 'Pure extraction', text: 'Every question type, no residue.' },
  { num: "02", title: 'Clear marking', text: 'Negatives in single green.' },
  { num: "03", title: 'Plain instructions', text: 'Verbatim, unadorned.' },
  { num: "04", title: 'Quick reduce', text: 'Forty seconds to essence.' },
  { num: "05", title: 'Simple palette', text: 'Three states, one hue.' },
  { num: "06", title: 'Neat analysis', text: 'Scores, undiluted.' },
];
