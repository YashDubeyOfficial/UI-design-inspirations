...
export const features: Feature[] = [
  { num: "01", title: 'PIPE EXTRACTION', text: 'Every question type through the pipe.' },
  { num: "02", title: 'GREP MARKING', text: 'Negatives matched, case-sensitive.' },
  { num: "03", title: 'CAT INSTRUCTIONS', text: 'Verbatim to stdout.' },
  { num: "04", title: 'NICE -20', text: 'Forty seconds, highest priority.' },
  { num: "05", title: 'TOP PALETTE', text: 'Answered, marked, unvisited processes.' },
  { num: "06", title: 'DF SCORES', text: 'Disk-full of accuracy.' },
];
