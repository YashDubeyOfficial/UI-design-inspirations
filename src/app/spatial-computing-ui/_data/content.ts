...
export const features: Feature[] = [
  { num: "01", title: 'Window extraction', text: 'Every question type, floating calmly.' },
  { num: "02", title: 'Gaze marking', text: 'Negatives noticed, never shouted.' },
  { num: "03", title: 'Nearby instructions', text: 'Verbatim, an arm away.' },
  { num: "04", title: 'Instant depth', text: 'Forty seconds to arrange the room.' },
  { num: "05", title: 'Orbital palette', text: 'Answered, marked, unvisited orbs.' },
  { num: "06", title: 'Quiet analysis', text: 'Scores that fade in softly.' },
];
