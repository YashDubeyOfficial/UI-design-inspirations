...
export const features: Feature[] = [
  { num: "01", title: 'Torn extraction', text: 'Every question type, ripped right.' },
  { num: "02", title: 'Stuck marking', text: 'Negatives glued down hard.' },
  { num: "03", title: 'Clipped instructions', text: 'Verbatim, slightly crooked. Perfect.' },
  { num: "04", title: 'Fast glue', text: 'Forty seconds. Still tacky.' },
  { num: "05", title: 'Sticker palette', text: 'Answered, marked, unvisited — collectible.' },
  { num: "06", title: 'Framed analysis', text: 'Scores ready for the fridge door.' },
];
