...
export const features: Feature[] = [
  { num: "01", title: 'Mist extraction', text: 'Every question type, breathed in.' },
  { num: "02", title: 'Glow marking', text: 'Negatives as ambient light.' },
  { num: "03", title: 'Air instructions', text: 'Verbatim, floating gently.' },
  { num: "04", title: 'One breath', text: 'Forty seconds, in and out.' },
  { num: "05", title: 'Fog palette', text: 'Answered, marked, unvisited wisps.' },
  { num: "06", title: 'Clearing analysis', text: 'Scores as the fog lifts.' },
];
